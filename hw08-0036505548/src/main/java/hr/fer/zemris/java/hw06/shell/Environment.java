...
public interface Environment {
	 ...
	 * @param path
	 * @throws ShellIOException if path is not directory that exists
	 */
	void setCurrentDirectory(Path path);
	/**
	 * Returns element with given key from shared data if one exists
	 * @param key returns object with given key
	 * @return object
	 */
	Object getSharedData(String key);
	/**
	 * Sets new object in shared data. Key cant be null.
	 * @param key of object
