...
public class ValueWrapper {
	 ...
	 * @return
	 */
	private <T> Object performOperation(Object secondOpertor, OperationType operationType) {
		...
		if (bothInt) {
			...
			default: this.value=(Integer) currentValue;
				return intOperation.numCompare((Integer) currentValue, (Integer) parsedIncValue);
			}
		} else {
			...
			default: this.value=val1;
				return doubleOperation.numCompare(val1, val2);
			}
		}
